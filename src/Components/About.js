...
class About extends Component {
  render() {
    ...
    const bio =
      "인하대학교 프런티어학부대학 교수 및 자유전공학부 학부장. 한양대학교 철학과 대학원에서 독일현대철학 전공으로 박사학위를 받았으며, 한양대학교, 경희대학교, 단국대학교 강사, 세종대학교 교양학부 초빙교수를 거쳤다. 포스트휴먼 시대의 인간 가치, 자유학예교육의 현대적 변용, 대학사, 미래 고등교육 변화와 교양교육 혁신 등에 관심을 가지고 연구와 교육을 병행하고 있으며, 교양교육, 윤리학, 해석학과 관련된 다양한 논문과 저서를 출간하였다.";
